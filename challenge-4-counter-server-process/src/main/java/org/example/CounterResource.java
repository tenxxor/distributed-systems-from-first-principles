...
/**
 * REST endpoint that exposes the CounterHelper's functionality over HTTP.
 *
 *   POST   /api/v1/counters                   create a counter
 *   DELETE /api/v1/counters/{id}              delete a counter
 *   GET    /api/v1/counters                   list all counters
 *   GET    /api/v1/counters/{id}              show one counter
 *   PUT    /api/v1/counters/{id}/vote         record/update a vote (X-User-Id header)
 *   DELETE /api/v1/counters/{id}/vote         clear a vote (X-User-Id header)
 *   GET    /api/v1/counters/{id}/vote         show the caller's vote on a counter (X-User-Id header)
 */
@Path("/v1/counters")
